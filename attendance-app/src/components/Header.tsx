          ...
          <>
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <button
                ...
                className="cursor-pointer bg-gradient-to-r text-white px-4 py-2 rounded-lg font-semibold hover:from-red-600 hover:to-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-all duration-300"
                aria-label="ログアウト"
              >
                ログアウト
              </button>
